#pragma once
// =============================================================================
// XpsParser.h  –  XPS/OXPS Document text extractor with coordinate mapping
// =============================================================================
// Uses IXpsOMObjectFactory1 (Windows 8+) which handles BOTH classic XPS
// and OpenXPS (OXPS) formats natively. The v4 XPS Document Writer produces
// OXPS, so this is required.
// =============================================================================
...
#include <windows.h>
#include <xpsobjectmodel_1.h>   // IXpsOMObjectFactory1 — reads OXPS + XPS
#include <string>
#include <vector>
#include <algorithm>
#include <cmath>
...
public:
    static bool Parse(const std::wstring& xpsFilePath, XpsDocument& doc)
    {
        ...
        // Use IXpsOMObjectFactory1 — this is the key difference.
        // It supports OXPS (OpenXPS) in addition to classic XPS.
        ...
        // Open the XPS/OXPS package using the factory1 method
        // CreatePackageFromFile1 reads both XPS and OXPS
        ...
        // From here, use the base IXpsOMPackage interface — it's the same
...
private:
    ...
    static void ExtractGlyphs(IXpsOMGlyphs* glyphs, XpsDocument& doc, int pageIdx)
    {
        ...
        // Better width from glyph indices
        {
            UINT32 indexCount = 0;
